...
import { createWar, createStars, getAllChampions, getAllCode, getAllUsers } from './supabaseClient.js';
...
async function starTurn(star) {
    ...
    if (star.owner && Math.random() < 0.25) {
        ...
        if (enemyStars.length > 0 && Math.random() > 0.25) {
